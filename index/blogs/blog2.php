...
<body>
    ...
    <div class="container">
        <div class="row">
        <h3>“If The World Is A Stage, Remember Our Children Are Sitting In The Front Row”</h3>
            <div class="col-md-6">
                <img src="child-development.jpg" alt="">
            </div>
            <div class="col-md-6">
                <br><br>
                <p>Like adults, children can also develop any mental health conditions anytime which can be hard to identify for parents. If you think your child is having any mental issues, then LifeSpring can provide the best solution in the path of child development. We can proudly say that we are the very first mental health service provider that provides the IQ Test for children. We are also planning to add more children-based mental health development treatment very soon.

                If you ever see a red flag and are concerned about your child’s mental health, just don’t be late. LifeSpring can be your best companion in terms of child development service. Our experts will see your child and come up with a solution you probably have been searching for ages.</p>
            </div>
        </div>
    </div>
